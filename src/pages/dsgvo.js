...
export default ({ data }) => (
  ...
  <Layout>
    ...
    <h1>DSGVO / Impressum</h1>
	  ...
	  <p>
	    Auf dieser Domain ist eine E-Mailadresse angegeben, welche für die elektronische Kontaktaufnahme genutzt werden kann. Nimmt ein Nutzer die Möglichkeit der (externen) Formulare wahr, so werden die in der Eingabemaske eingegebenen Daten an uns übermittelt und gespeichert. Das sind:        
	  </p>
	  <ol>
	    <li>Name</li>
	    <li>ggf. Straße und Hausnummer</li>
	    <li>ggf. PLZ und Ort</li>
	    <li>Mailadresse</li>
	    <li>Betreff</li>
	  ...
	  <h4>Recht auf Löschung<br />Löschungspflicht</h4>
	  <p>
